...
class TestDateTimeGenerator:
    ...
    def test_basic_datetime_generation(self):
        ...
        config = DateFieldConfig(
            start_date="2023-01-01", end_date="2023-12-31", date_format="%Y-%m-%d"
        )
    ...
    def test_custom_date_format(self):
        ...
        config = DateFieldConfig(
            start_date="2023-06-01", end_date="2023-06-30", date_format="%m/%d/%Y"
        )
    ...
    def test_datetime_object_generation(self):
        ...
        config = DateFieldConfig(start_date="2023-01-01", end_date="2023-01-31")
    ...
    def test_custom_pattern_generation(self):
        ...
        config = DateFieldConfig(start_date="2023-01-01", end_date="2023-12-31")
    ...
    def test_batch_generation_optimized(self):
        ...
        config = DateFieldConfig(
            start_date="2023-01-01", end_date="2023-01-31", date_format="%Y-%m-%d"
        )
    ...
    def test_date_range_info(self):
        ...
        config = DateFieldConfig(
            start_date="2023-06-01", end_date="2023-06-30", date_format="%Y-%m-%d"
        )
    ...
    def test_various_date_formats_parsing(self):
        ...
        for start_date, format_str in test_cases:
            config = DateFieldConfig(
                start_date=start_date, end_date="2023-12-31", date_format=format_str
            )
