...
class TestStringGenerator:
    ...
    def test_random_string_generation(self):
        ...
        config = StringFieldConfig(
            subtype=StringSubtype.RANDOM, min_length=5, max_length=10
        )
    ...
    def test_first_name_generation(self):
        ...
        for _ in range(5):
            ...
            assert len(value) > 0
            assert (
                value.isalpha() or "'" in value or "-" in value
            )  # Handle names like O'Connor or Jean-Luc
    ...
    def test_choices_generation(self):
        ...
        config = StringFieldConfig(subtype=StringSubtype.RANDOM, choices=choices)
    ...
    def test_length_constraints_truncation(self):
        ...
        config = StringFieldConfig(subtype=StringSubtype.EMAIL, max_length=10)
    ...
    def test_length_constraints_padding(self):
        ...
        config = StringFieldConfig(
            subtype=StringSubtype.RANDOM, min_length=20, max_length=25
        )
    ...
    def test_validation(self):
        ...
        config = StringFieldConfig(
            subtype=StringSubtype.EMAIL, min_length=5, max_length=50
        )
